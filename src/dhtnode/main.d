...
*******************************************************************************/
    ...
    public class DhtNodeServer : DaemonApp
    {
        ...
        import core.sys.posix.sys.mman : mlockall, MCL_CURRENT,
               MCL_FUTURE;
        ...
        ***************************************************************************/
        ...
        public override void processConfig (IApplication app,
            ConfigParser config)
        {
            ...
            enforce(Hash.hashDigestToHashT(this.server_config.minval(), min,
                    true),
                "Minimum hash specified in config file is invalid -- "
                "a full-length hash is expected");

            enforce(Hash.hashDigestToHashT(this.server_config.maxval(), max,
                    true),
        ...
        ***************************************************************************/
        ...
        {
            this.storage_channels = new StorageChannels(
        ...
        ***************************************************************************/
            ...
            DhtConnectionHandler.IConnectionHandlerInfo conn)
        {
            ...
            else
            {
                ...
                logger.error(
                    "Exception caught in eventLoop: '{}' @ {}:{} on {}",
                    exception.message, exception.file, exception.line,
                    this.conn_error_buf);
            }
        }
        ...
        ***************************************************************************/
        ...
        else
        {
            ...
            ***********************************************************************/
            ...
            {
                logger.trace(
                    "Finished GC collection: {} bytes freed, {} bytes freed within full pages",
                    freed, pagebytes);
            }
        }
    }
